...
[dmeo-1\_常用过渡动画](./demo/2_使用react-transition-group完成过场动画/1_常用过渡动画)
...
[2_umi4-transition-group-routers 过渡](./demo/2_使用react-transition-group完成过场动画/2_umi4-transition-group-routers过渡/src/layouts/index.tsx)
...
[3_create-react-app-transition-group-router 过渡](./demo/2_使用react-transition-group完成过场动画/3_create-react-app-transition-group-router%E8%BF%87%E6%B8%A1)
...
# TransitionGroup_childFactory 参数的作用
...
如果您确实需要在 child 离开时更新它，您可以提供一个 childFactory 来包装每个 child，甚至是离开的 child。
